...
export default function Home() {
    ...
    return (
        <div>
            ...
            <p>
                We do a lot of things - we will build your CI pipeline and deploy the app to make sure it has 100%
                uptime. Meanwhile, we will also inject our *analytics* into your app to make sure that we get most of
                the customer data to sell on dark web forums.
            </p>
